-- 0025: de strook boven de klok in de meting.
-- Draai dit in de Supabase SQL-editor, na 0019 tot en met 0024. Volledige
-- vervanging, zoals eerder: alles uit de vorige migraties zit hierin.
--
-- Wat erbij komt: `deals.by_strip`. De strook boven de klok is iets anders
-- dan de kaart eronder, met een andere vraag: hoeveel mensen tikken erop als
-- ze hem zien. Die twee door elkaar tellen zou allebei de cijfers vertroebelen,
-- dus `deal_strip_seen` en `deal_strip_tap` krijgen hun eigen regel naast de
-- kaartvormen.
--
-- `card_mode` gaat mee omdat de strook nu alleen tussen half vijf en negen
-- verschijnt, hetzelfde venster als de volledige kaart. Verandert dat venster
-- ooit, dan is achteraf nog te zien in welke vorm hij stond.
